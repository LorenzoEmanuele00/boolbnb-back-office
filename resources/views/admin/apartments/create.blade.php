            ...
            <div class="col-6 mb-5">
                <form action="{{ route('admin.apartments.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('dimension_mq') is-invalid @enderror" id="dimension_mq" name="dimension_mq" value="{{ old('dimension_mq') }}">
                    </div>
                    @error('dimension_mq')
                        <div class="alert alert-danger">
                            <div>{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('rooms_number') is-invalid @enderror" id="rooms_number" name="rooms_number" value="{{ old('rooms_number') }}">
                    </div>
                    @error('rooms_number')
                        <div class="alert alert-danger">
                            <div>{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('beds_number') is-invalid @enderror" id="beds_number" name="beds_number" value="{{ old('beds_number') }}">
                    </div>
                    @error('beds_number')
                        <div class="alert alert-danger">
                            <div>{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('bathrooms_number') is-invalid @enderror" id="bathrooms_number" name="bathrooms_number" value="{{ old('bathrooms_number') }}">
                    </div>
